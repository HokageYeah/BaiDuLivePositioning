...
@interface RouteSearchControl ()<BMKRouteSearchDelegate>

@property (nonatomic,strong)BMKRouteSearch* routesearch;//rou搜索服务

@end

@implementation RouteSearchControl
...
#pragma mark - BMKRouteSearchDelegate,几种不同的路径规划
